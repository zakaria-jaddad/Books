...
typedef struct _iobuf
{
  ...
  struct
  {
    unsigned char _READ;  /* file open for reading */
    unsigned char _WRITE; /* file open for writing */
    unsigned char _UNBUF; /* file is unbuffered */
    unsigned char _EOF;   /* EOF has accurred on the file */
    unsigned char _ERR;   /* error occurred on this file*/
